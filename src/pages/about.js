        ...
        return (
            <div className="page-content" id="about-page">
                ...
                <div className="inner">
                    ...
                    <p>I am currently working as a <b>Lead CMS Web Developer</b> at <a href="https://www.simpleview.com/" target="_blank">Simpleview</a>, a company that builds marketing websites for DMOs (Destination Marketing Organizations). There, I have worked on over 150 destination websites from hotels sites such as <a to="https://www.napariverinn.com/" target="_blank">Napa River Inn</a> to large sites for countries, such as <a href="https://www.visitnorway.com/" target="_blank">Visit Norway</a>. Please see my projects page to see just a few of the builds I have been most proud to work on.</p>
                    ...
                    <p>I am also pasionate about helping people with disabilies like me. In highschool I was diagnosed with Spinal Muscular Atrophy (SMA), a debilitating nerve disease and my muscles started to slowly get weaker. As an athlete it was difficult to come to terms with this new reality. Now, I use a wheelchair to get around -- I can still walk some but it's a struggle. Out of this challenge <a href="https://magicspaceship.org/" target="_blank">Project Magic Spaceship</a> tookoff. With the help of friends and family I set off to do something too difficult for me to do alone because of my handicap, and this is something I want to help others like me to be able to do.</p>
                </div>
